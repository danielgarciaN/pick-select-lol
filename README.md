...
- **`ModuleNotFoundError: No module named core` en Streamlit**: actualizado para autoinyectar la raíz del repo en `sys.path` desde `app/path_setup.py`; asegúrate de ejecutar desde la raíz con `streamlit run app/Home.py`.
